...
pub const Ktx2SuperCompression_None: Ktx2SuperCompression = 0;
pub const Ktx2SuperCompression_ZStandard: Ktx2SuperCompression = 2;
pub type Ktx2SuperCompression = ::std::os::raw::c_int;
extern "C" {
...
extern "C" {
    pub fn compressor_params_set_ktx2_uastc_zstd_supercompression_level(
        params: *mut CompressorParams,
